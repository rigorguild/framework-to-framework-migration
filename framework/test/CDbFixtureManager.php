...
class CDbFixtureManager extends CApplicationComponent
{
	...
	public function init()
	{
		...
		if($this->basePath===null)
			$this->basePath=OldYii::getPathOfAlias('application.tests.fixtures');
		$this->prepare();
	}
	...
	public function getDbConnection()
	{
		if($this->_db===null)
		{
			$this->_db=OldYii::app()->getComponent($this->connectionID);
			if(!$this->_db instanceof CDbConnection)
				throw new CException(OldYii::t('yii','CDbTestFixture.connectionID "{id}" is invalid. Please make sure it refers to the ID of a CDbConnection application component.',
	...
	public function load($fixtures)
	{
		...
		foreach($fixtures as $fixtureName=>$tableName)
		{
			...
			{
				$modelClass=OldYii::import($tableName,true);
