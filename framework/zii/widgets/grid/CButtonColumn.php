...
OldYii::import('zii.widgets.grid.CGridColumn');
...
class CButtonColumn extends CGridColumn
{
	 ...
	 */
	public $viewButtonUrl='OldYii::app()->controller->createUrl("view",array("id"=>$data->primaryKey))';
	/**
	 ...
	 * please refer to the {@link http://www.php.net/manual/en/language.expressions.php php manual}.
	 */
	public $updateButtonUrl='OldYii::app()->controller->createUrl("update",array("id"=>$data->primaryKey))';
	/**
	 ...
	 * please refer to the {@link http://www.php.net/manual/en/language.expressions.php php manual}.
	 */
	public $deleteButtonUrl='OldYii::app()->controller->createUrl("delete",array("id"=>$data->primaryKey))';
	/**
	...
	protected function initDefaultButtons()
	{
		if($this->viewButtonLabel===null)
			$this->viewButtonLabel=OldYii::t('zii','View');
		if($this->updateButtonLabel===null)
			$this->updateButtonLabel=OldYii::t('zii','Update');
		if($this->deleteButtonLabel===null)
			$this->deleteButtonLabel=OldYii::t('zii','Delete');
		...
		if($this->deleteConfirmation===null)
			$this->deleteConfirmation=OldYii::t('zii','Are you sure you want to delete this item?');
		...
		if(!isset($this->buttons['delete']['click']))
		{
			...
			if(OldYii::app()->request->enableCsrfValidation)
			{
				$csrfTokenName = OldYii::app()->request->csrfTokenName;
				$csrfToken = OldYii::app()->request->csrfToken;
...
EOD;
	...
	protected function registerClientScript()
	{
		...
		if($js!==array())
			OldYii::app()->getClientScript()->registerScript(__CLASS__.'#'.$this->id, implode("\n",$js));
	}
