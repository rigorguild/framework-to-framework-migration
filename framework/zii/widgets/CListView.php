	...
	*/
	...
	public function init()
	{
		if($this->itemView===null)
			throw new CException(OldYii::t('zii','The property "itemView" cannot be empty.'));
		parent::init();
		...
		if($this->baseScriptUrl===null)
			$this->baseScriptUrl=OldYii::app()->getAssetManager()->publish(OldYii::getPathOfAlias('zii.widgets.assets')).'/listview';
	...
	public function renderSorter()
	{
		...
		echo $this->sorterHeader===null ? OldYii::t('zii','Sort by: ') : $this->sorterHeader;
		echo "<ul>\n";
