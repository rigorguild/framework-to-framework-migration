...
class CRangeValidator extends CValidator
{
	...
	protected function validateAttribute($object,$attribute)
	{
		...
		if(!is_array($this->range))
			throw new CException(OldYii::t('yii','The "range" property must be specified with a list of values.'));
		$result = false;
		if($this->strict)
		...
		if(!$this->not && !$result)
		{
			$message=$this->message!==null?$this->message:OldYii::t('yii','{attribute} is not in the list.');
			$this->addError($object,$attribute,$message);
		}
		elseif($this->not && $result)
		{
			$message=$this->message!==null?$this->message:OldYii::t('yii','{attribute} is in the list.');
			$this->addError($object,$attribute,$message);
		}
	}
	...
	public function clientValidateAttribute($object,$attribute)
	{
		...
		if(($message=$this->message)===null)
			$message=$this->not ? OldYii::t('yii','{attribute} is in the list.') : OldYii::t('yii','{attribute} is not in the list.');
