...
class CStringValidator extends CValidator
{
	...
	protected function validateAttribute($object,$attribute)
	{
		...
		if(is_array($value))
		{
			...
			$this->addError($object,$attribute,OldYii::t('yii','{attribute} is invalid.'));
			return;
		}

		if(function_exists('mb_strlen') && $this->encoding!==false)
			$length=mb_strlen($value, $this->encoding ? $this->encoding : OldYii::app()->charset);
		else
			$length=strlen($value);

		if($this->min!==null && $length<$this->min)
		{
			$message=$this->tooShort!==null?$this->tooShort:OldYii::t('yii','{attribute} is too short (minimum is {min} characters).');
			$this->addError($object,$attribute,$message,array('{min}'=>$this->min));
		}
		if($this->max!==null && $length>$this->max)
		{
			$message=$this->tooLong!==null?$this->tooLong:OldYii::t('yii','{attribute} is too long (maximum is {max} characters).');
			$this->addError($object,$attribute,$message,array('{max}'=>$this->max));
		}
		if($this->is!==null && $length!==$this->is)
		{
			$message=$this->message!==null?$this->message:OldYii::t('yii','{attribute} is of the wrong length (should be {length} characters).');
	...
	public function clientValidateAttribute($object,$attribute)
	{
		...
		if(($message=$this->message)===null)
			$message=OldYii::t('yii','{attribute} is of the wrong length (should be {length} characters).');
		...
		if(($tooShort=$this->tooShort)===null)
			$tooShort=OldYii::t('yii','{attribute} is too short (minimum is {min} characters).');
		...
		if(($tooLong=$this->tooLong)===null)
			$tooLong=OldYii::t('yii','{attribute} is too long (maximum is {max} characters).');
