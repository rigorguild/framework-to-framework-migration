...
class CEmailValidator extends CValidator
{
	...
	protected function validateAttribute($object,$attribute)
	{
		...
		{
			$message=$this->message!==null?$this->message:OldYii::t('yii','{attribute} is not a valid email address.');
	...
	public function clientValidateAttribute($object,$attribute)
	{
		if($this->validateIDN)
		{
			OldYii::app()->getClientScript()->registerCoreScript('punycode');
...
";
	...
	private function encodeIDN($value)
	{
		if(preg_match_all('/^(.*)@(.*)$/',$value,$matches))
		{
			...
			{
				require_once(OldYii::getPathOfAlias('system.vendors.Net_IDNA2.Net').DIRECTORY_SEPARATOR.'IDNA2.php');
				$idna=new Net_IDNA2();
