...
class CMap extends CComponent implements IteratorAggregate,ArrayAccess,Countable
{
	...
	public function add($key,$value)
	{
		if(!$this->_r)
		{
			...
			throw new CException(OldYii::t('yii','The map is read only.'));
	}
	...
	public function copyFrom($data)
	{
		...
		elseif($data!==null)
			throw new CException(OldYii::t('yii','Map data must be an array or an object implementing Traversable.'));
	}
