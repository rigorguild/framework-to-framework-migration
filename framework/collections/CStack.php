...
class CStack extends CComponent implements IteratorAggregate,Countable
{
	...
	public function copyFrom($data)
	{
		...
		elseif($data!==null)
			throw new CException(OldYii::t('yii','Stack data must be an array or an object implementing Traversable.'));
	}
	...
	public function peek()
	{
		if($this->_c)
			...
			throw new CException(OldYii::t('yii','The stack is empty.'));
	}
