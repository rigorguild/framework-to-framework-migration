...
class MigrateCommand extends CConsoleCommand
{
	...
	{
		$path=OldYii::getPathOfAlias($this->migrationPath);
	...
	protected function getDbConnection()
	{
		if($this->_db!==null)
			return $this->_db;
		elseif(($this->_db=OldYii::app()->getComponent($this->connectionID)) instanceof CDbConnection)
			return $this->_db;
...
EOD;
	...
	protected function getTemplate()
	{
		if($this->templateFile!==null)
			return file_get_contents(OldYii::getPathOfAlias($this->templateFile).'.php');
		else
			return <<<EOD
<?php
