...
EOD;
	...
	public function run($args)
	{
		...
		OldYii::setApplication(null);
		OldYii::setPathOfAlias('application',null);
		...
		if(is_array($config))
		{
			...
			OldYii::createWebApplication($config);
		}

		restore_error_handler();
		restore_exception_handler();

		$yiiVersion=OldYii::getVersion();
		echo <<<EOD
...
EOD;
	...
	{
		$runner->addCommands(OldYii::getPathOfAlias('system.cli.commands.shell'));
		$runner->addCommands(OldYii::getPathOfAlias('application.commands.shell'));
