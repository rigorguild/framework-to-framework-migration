...
$this->menu=array(
	...
	array('label'=>'Delete <?php echo $modelClass; ?>', 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model-><?php echo $ID; ?>),'confirm'=>OldYii::t('zii','Are you sure you want to delete this item?'))),
