	...
	protected function getDbConnection()
	{
		...
		elseif(($id=$this->connectionID)!==null)
		{
			if(($this->_db=OldYii::app()->getComponent($id)) instanceof CDbConnection)
				...
				throw new CException(OldYii::t('yii','CDbLogRoute.connectionID "{id}" does not point to a valid CDbConnection application component.',
					array('{id}'=>$id)));
		}
		else
		{
			$dbFile=OldYii::app()->getRuntimePath().DIRECTORY_SEPARATOR.'log-'.OldYii::getVersion().'.db';
