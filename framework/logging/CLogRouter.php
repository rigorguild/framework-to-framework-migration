...
class CLogRouter extends CApplicationComponent
{
	...
	public function init()
	{
		...
		{
			$route=OldYii::createComponent($route);
			$route->init();
			$this->_routes[$name]=$route;
		}
		OldYii::getLogger()->attachEventHandler('onFlush',array($this,'collectLogs'));
		OldYii::app()->attachEventHandler('onEndRequest',array($this,'processLogs'));
	}
