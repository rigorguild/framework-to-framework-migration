...
class CStatePersister extends CApplicationComponent implements IStatePersister
{
	...
	public function init()
	{
		...
		if($this->stateFile===null)
			$this->stateFile=OldYii::app()->getRuntimePath().DIRECTORY_SEPARATOR.'state.bin';
		$dir=dirname($this->stateFile);
		if(!is_dir($dir) || !is_writable($dir))
			throw new CException(OldYii::t('yii','Unable to create application state file "{file}". Make sure the directory containing the file exists and is writable by the Web server process.',
