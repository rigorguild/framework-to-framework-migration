...
class CComponent
{
	...
	public function __get($name)
	{
		...
		throw new CException(OldYii::t('yii','Property "{class}.{property}" is not defined.',
	...
	public function __set($name,$value)
	{
		...
		if(method_exists($this,'get'.$name))
			throw new CException(OldYii::t('yii','Property "{class}.{property}" is read only.',
				array('{class}'=>get_class($this), '{property}'=>$name)));
		else
			throw new CException(OldYii::t('yii','Property "{class}.{property}" is not defined.',
				array('{class}'=>get_class($this), '{property}'=>$name)));
	...
	public function __call($name,$parameters)
	{
		...
		throw new CException(OldYii::t('yii','{class} and its behaviors do not have a method or closure named "{name}".',
	...
	public function attachBehavior($name,$behavior)
	{
		if(!($behavior instanceof IBehavior))
			$behavior=OldYii::createComponent($behavior);
	...
	public function getEventHandlers($name)
	{
		if($this->hasEvent($name))
		{
			...
			throw new CException(OldYii::t('yii','Event "{class}.{event}" is not defined.',
				...
				elseif(is_callable($handler,true))
				{
					if(is_array($handler))
					{
						...
						elseif(method_exists($object,$method))
							...
							throw new CException(OldYii::t('yii','Event "{class}.{event}" is attached with an invalid handler "{handler}".',
