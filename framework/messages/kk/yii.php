...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to OldYii::beginProfile() and OldYii::endProfile() be properly nested.' => 'CProfileLogRoute компоненті қате "{token}" кодын анықтады. OldYii::beginProfile() мен OldYii::endProfile() шақырулардың ішке салынуы дұрыстығын тексеріңіз.',
