...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to OldYii::beginProfile() and OldYii::endProfile() be properly nested.' => 'CProfileLogRoute عثر على الكتلة البرمجية "{token}" الغير مطابقة. تأكد من أن النداءات إلى OldYii::beginProfile() و OldYii::endProfile() متداخلة بشكل صحيح.',
