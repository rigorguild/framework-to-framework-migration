...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to OldYii::beginProfile() and OldYii::endProfile() be properly nested.' => 'CProfileLogRoute found a mismatching code block "{token}". 請確定對於 OldYii::beginProfile() 與 OldYii::endProfile() 的呼叫是適當地巢狀套疊的.',
