...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to OldYii::beginProfile() and OldYii::endProfile() be properly nested.' => 'CProfileLogRoute가 일치하지 않는 코드 블록 "{token}"를 찾았습니다. OldYii::beginProfile()와 OldYii::endProfile() 호출이 올바르게 중첩되어 있는지 확인하십시오.',
