...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to OldYii::beginProfile() and OldYii::endProfile() be properly nested.' => 'CProfileLogRoute је нашао неусаглашен блок кода "{token}". Будите сигурни да су позиви OldYii::beginProfile() и OldYii::endProfile() исправно угњеждени.',
