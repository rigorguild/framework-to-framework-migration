...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to OldYii::beginProfile() and OldYii::endProfile() be properly nested.' => 'CProfileLogRoute tìm thấy đoạn code code không đúng "{token}". Hãy chắc rằng các call tới OldYii::beginProfile() và OldYii::endProfile() phải được nest một cách đúng đắn.',
