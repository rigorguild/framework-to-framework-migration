...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to OldYii::beginProfile() and OldYii::endProfile() be properly nested.' => 'CProfileLogRoute намери несъответстващ блок от код "{token}". Моля, проверете дали обръщането към OldYii::beginProfile() и OldYii::endProfile() е вложено правилно.',
