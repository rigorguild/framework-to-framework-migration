...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to OldYii::beginProfile() and OldYii::endProfile() be properly nested.' => 'Το CProfileLogRoute βρήκε ένα τμήμα κώδικα "{token}" που δεν ταιριάζει. Επιβεβαιώστε ότι οι κλήσεις στο OldYii::beginProfile() και OldYii::endProfile() είναι σωστά φωλιασμένες.',
