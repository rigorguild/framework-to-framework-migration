...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to OldYii::beginProfile() and OldYii::endProfile() be properly nested.' => 'CProfileLogRoute fandt en mismatchende kodeblock "{token}". Tjek at kaldene til OldYii::beginProfile() og OldYii::endProfile() er korrekt indlejret.',
