...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to OldYii::beginProfile() and OldYii::endProfile() be properly nested.' => 'CProfileLogRoute が整合の取れないコードブロック "{token}" を見つけました。OldYii::beginProfile() と OldYii::endProfile()の呼び出しが正しくネストされているか確認してください。',
