...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to OldYii::beginProfile() and OldYii::endProfile() be properly nested.' => 'CProfileLogRoute ha trobat un bloc de codi "{token}" desalineat. Asseguri\'s de que las crides a OldYii::beginProfile() i a OldYii::endProfile() estan correctament anidades.',
