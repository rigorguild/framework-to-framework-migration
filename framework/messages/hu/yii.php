...
'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to OldYii::beginProfile() and OldYii::endProfile() be properly nested.' => 'A CProfileLogRoute nem egyező kód-blokkot talált "{token}". Kérjük, győződjön meg róla, hogy a Yii:beginProfile és Yii:endProfile hívásai megfelelően vannak beágyazva.',
