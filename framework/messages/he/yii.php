...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to OldYii::beginProfile() and OldYii::endProfile() be properly nested.' => 'CProfileLogRoute מצא בלוק אשר לא תואם בשרשור שלו "{token}". אנא וודא שקריאות ל OldYii::beginProfile() ו OldYii::endProfile() משורשרות בהתאם.',
