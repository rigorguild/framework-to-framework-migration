...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to OldYii::beginProfile() and OldYii::endProfile() be properly nested.' => 'CProfileLogRoute fant en mismatchende kodeblock "{token}". Sjekk at kallene til  OldYii::beginProfile() og OldYii::endProfile() er riktig nøstet.',
