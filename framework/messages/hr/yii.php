...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to OldYii::beginProfile() and OldYii::endProfile() be properly nested.' => 'CProfileLogRoute je našao neusaglašen blok koda "{token}". Budite sigurni da su pozivi OldYii::beginProfile() i OldYii::endProfile() ispravno ugnježdeni.',
