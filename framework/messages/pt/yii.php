...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to OldYii::beginProfile() and OldYii::endProfile() be properly nested.' => 'CProfileLogRoute encontrou uma combinação errada no bloco de código "{token}". Tente chamar OldYii::beginProfile() e OldYii::endProfile() para ser apropriadamente aninhado.',
