...
class CAccessControlFilter extends CFilter
{
	...
	protected function resolveErrorMessage($rule)
	{
		...
		elseif($this->message!==null)
			...
			return OldYii::t('yii','You are not authorized to perform this action.');
	}
...
class CAccessRule extends CComponent
{
	 ...
	 * In this expression, you can use <code>$user</code> which refers to <code>OldYii::app()->user</code>.
