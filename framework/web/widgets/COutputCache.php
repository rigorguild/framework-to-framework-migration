...
class COutputCache extends CFilterWidget
{
	 ...
	 * A language is retrieved via OldYii::app()->language.
	 * Defaults to false.
	 * @since 1.1.14
	 */
	...
	public function run()
	{
		...
		elseif($this->_cache!==null)
		{
			...
			if(is_array($this->dependency))
				$this->dependency=OldYii::createComponent($this->dependency);
	...
	{
		if((empty($this->requestTypes) || in_array(OldYii::app()->getRequest()->getRequestType(),$this->requestTypes))
	...
	{
		return OldYii::app()->getComponent($this->cacheID);
	}
	...
	protected function getCacheKey()
	{
		...
		else
		{
			...
			if($this->varyBySession)
				$key.=OldYii::app()->getSession()->getSessionID();
			$key.='.';
	...
	protected function replayActions()
	{
		...
		foreach($this->_actions as $action)
		{
			...
			elseif($action[0]==='' && function_exists($action[1]))
				...
				throw new CException(OldYii::t('yii','Unable to replay the action "{object}.{method}". The method does not exist.',
