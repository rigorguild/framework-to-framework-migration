...
class CCaptcha extends CWidget
{
	...
	public function run()
	{
		if(self::checkRequirements('imagick') || self::checkRequirements('gd'))
		{
			...
			throw new CException(OldYii::t('yii','GD with FreeType or ImageMagick PHP extensions are required.'));
	}
	...
	public function registerClientScript()
	{
		...
		if($this->showRefreshButton)
		{
			...
			$label=$this->buttonLabel===null?OldYii::t('yii','Get a new code'):$this->buttonLabel;
