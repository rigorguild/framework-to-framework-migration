...
class CLinkPager extends CBasePager
{
	...
	public function init()
	{
		if($this->nextPageLabel===null)
			$this->nextPageLabel=OldYii::t('yii','Next &gt;');
		if($this->prevPageLabel===null)
			$this->prevPageLabel=OldYii::t('yii','&lt; Previous');
		if($this->firstPageLabel===null)
			$this->firstPageLabel=OldYii::t('yii','&lt;&lt; First');
		if($this->lastPageLabel===null)
			$this->lastPageLabel=OldYii::t('yii','Last &gt;&gt;');
		if($this->header===null)
			$this->header=OldYii::t('yii','Go to page: ');
	...
	{
		if($url===null)
			$url=CHtml::asset(OldYii::getPathOfAlias('system.web.widgets.pagers.pager').'.css');
