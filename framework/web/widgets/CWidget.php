...
class CWidget extends CBaseController
{
	...
	{
		$this->_owner=$owner===null?OldYii::app()->getController():$owner;
	}
	...
	public function getController()
	{
		if($this->_owner instanceof CController)
			...
			return OldYii::app()->getController();
	}
	...
	public function getViewPath($checkTheme=false)
	{
		...
		{
			if($checkTheme && ($theme=OldYii::app()->getTheme())!==null)
			{
	...
	public function render($view,$data=null,$return=false)
	{
		if(($viewFile=$this->getViewFile($view))!==false)
			...
			throw new CException(OldYii::t('yii','{widget} cannot find the view "{view}".',
