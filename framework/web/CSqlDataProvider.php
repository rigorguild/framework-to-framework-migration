 ...
 * <pre>
 * $count=OldYii::app()->db->createCommand('SELECT COUNT(*) FROM tbl_user')->queryScalar();
...
class CSqlDataProvider extends CDataProvider
{
	 ...
	 * Defaults to null, meaning using OldYii::app()->db.
	 */
	public $db;
	/**
	...
	protected function fetchData()
	{
		...
		{
			$db=$this->db===null ? OldYii::app()->db : $this->db;
