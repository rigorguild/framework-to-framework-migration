...
class CSqliteSchema extends CDbSchema
{
	...
	{
		throw new CDbException(OldYii::t('yii', 'Dropping DB column is not supported by SQLite.'));
	}
	...
	{
		throw new CDbException(OldYii::t('yii', 'Renaming a DB column is not supported by SQLite.'));
	}
	...
	{
		throw new CDbException(OldYii::t('yii', 'Adding a foreign key constraint to an existing table is not supported by SQLite.'));
	}
	...
	{
		throw new CDbException(OldYii::t('yii', 'Dropping a foreign key constraint is not supported by SQLite.'));
	}
	...
	{
		throw new CDbException(OldYii::t('yii', 'Altering a DB column is not supported by SQLite.'));
	}
	...
	{
		throw new CDbException(OldYii::t('yii', 'Adding a primary key after table has been created is not supported by SQLite.'));
	}
	...
	{
		throw new CDbException(OldYii::t('yii', 'Removing a primary key after table has been created is not supported by SQLite.'));
