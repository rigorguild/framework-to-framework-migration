...
class CDbTransaction extends CComponent
{
	...
	public function commit()
	{
		...
		{
			OldYii::trace('Committing transaction','system.db.CDbTransaction');
			$this->_connection->getPdoInstance()->commit();
			$this->_active=false;
		}
		else
			throw new CDbException(OldYii::t('yii','CDbTransaction is inactive and cannot perform commit or roll back operations.'));
	}
	...
	public function rollback()
	{
		if($this->_active && $this->_connection->getActive())
		{
			OldYii::trace('Rolling back transaction','system.db.CDbTransaction');
