...
class ModuleCode extends CCodeModel
{
	...
	{
		if(OldYii::app()->hasModule($this->moduleID))
			return 'The module has been generated successfully. You may '.CHtml::link('try it now', OldYii::app()->createUrl($this->moduleID), array('target'=>'_blank')).'.';
...
EOD;
	...
	{
		return OldYii::app()->modulePath.DIRECTORY_SEPARATOR.$this->moduleID;
	}
}
