...
class CrudCode extends CCodeModel
{
	...
	{
		$link=CHtml::link('try it now', OldYii::app()->createUrl($this->controller), array('target'=>'_blank'));
	...
	public function validateModel($attribute,$params)
	{
		if($this->hasErrors('model'))
			return;
		$class=@OldYii::import($this->model,true);
	...
	public function getModule()
	{
		if(($pos=strpos($this->controller,'/'))!==false)
		{
			...
			if(($module=OldYii::app()->getModule($id))!==null)
				return $module;
		}
		return OldYii::app();
	}
