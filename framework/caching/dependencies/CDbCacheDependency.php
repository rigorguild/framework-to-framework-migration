...
class CDbCacheDependency extends CCacheDependency
{
	...
	protected function generateDependentData()
	{
		if($this->sql!==null)
		{
			...
			throw new CException(OldYii::t('yii','CDbCacheDependency.sql cannot be empty.'));
	}
	...
	protected function getDbConnection()
	{
		...
		{
			if(($this->_db=OldYii::app()->getComponent($this->connectionID)) instanceof CDbConnection)
				return $this->_db;
			else
				throw new CException(OldYii::t('yii','CDbCacheDependency.connectionID "{id}" is invalid. Please make sure it refers to the ID of a CDbConnection application component.',
