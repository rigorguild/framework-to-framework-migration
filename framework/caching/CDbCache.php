	...
	public function getDbConnection()
	{
		...
		elseif(($id=$this->connectionID)!==null)
		{
			if(($this->_db=OldYii::app()->getComponent($id)) instanceof CDbConnection)
				...
				throw new CException(OldYii::t('yii','CDbCache.connectionID "{id}" is invalid. Please make sure it refers to the ID of a CDbConnection application component.',
					array('{id}'=>$id)));
		}
		else
		{
			$dbFile=OldYii::app()->getRuntimePath().DIRECTORY_SEPARATOR.'cache-'.OldYii::getVersion().'.db';
