 ...
 * Therefore, one may call <code>OldYii::app()->format->boolean(1)</code>.
...
class CFormatter extends CApplicationComponent
{
	...
	public function format($value,$type)
	{
		...
		if(method_exists($this,$method))
			...
			throw new CException(OldYii::t('yii','Unknown type "{type}".',array('{type}'=>$type)));
	}
	...
	public function formatSize($value,$verbose=false)
	{
		...
		{
			case 0:
				return $verbose ? OldYii::t('yii','{n} byte|{n} bytes',$params) : OldYii::t('yii', '{n} B',$params);
			case 1:
				return $verbose ? OldYii::t('yii','{n} kilobyte|{n} kilobytes',$params) : OldYii::t('yii','{n} KB',$params);
			case 2:
				return $verbose ? OldYii::t('yii','{n} megabyte|{n} megabytes',$params) : OldYii::t('yii','{n} MB',$params);
			case 3:
				return $verbose ? OldYii::t('yii','{n} gigabyte|{n} gigabytes',$params) : OldYii::t('yii','{n} GB',$params);
			default:
				return $verbose ? OldYii::t('yii','{n} terabyte|{n} terabytes',$params) : OldYii::t('yii','{n} TB',$params);
		}
	}
}
